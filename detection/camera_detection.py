# USAGE
# python camera_detection.py --prototxt models/MobileNetSSD_deploy.prototxt --model models/MobileNetSSD_deploy.caffemodel --output videos/output.avi
...
#
# ZACH: can use this information in order to determine the ideal fps and from that the flow rate needed
#
fps.stop()
